...
import "./chunk-GHOKBUH2.js";
import "./chunk-GCEFSD4J.js";
import {
  useButtonProps
} from "./chunk-G4I775HW.js";
import {
  CardHeaderContext_default
} from "./chunk-KQULY6XR.js";
import {
  createWithBsPrefix
...
var NavLink = React2.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
  ...
  return (0, import_jsx_runtime2.jsx)(Component, __spreadProps(__spreadValues(__spreadValues({}, props), navItemProps), {
    ref,
...
var Nav = React3.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Nav_default, __spreadValues({
    as,
    ref,
    activeKey,
