...
var CardImg = React.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    variant,
  ...
  return (0, import_jsx_runtime.jsx)(Component, __spreadValues({
    ref,
...
var CardHeader = React2.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(CardHeaderContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime2.jsx)(Component, __spreadProps(__spreadValues({
      ref
    }, props), {
...
var Card = React3.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Component, __spreadProps(__spreadValues({
    ref
  }, props), {
